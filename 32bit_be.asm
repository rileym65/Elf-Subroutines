...
; ************************************************
add32:   inc      r7                ; move to lsb
         inc      r7
         inc      r7
         inc      r8                ; of both numbers
         inc      r8
         inc      r8
         sex      r7                ; point x to first number
         ldn      r8                ; get lsb from second number
         add                        ; add to first number
         stxd                       ; and save it
         dec      r8                ; prior byte in second number
         ldn      r8                ; get lsb from second number
         adc                        ; add to first number
         stxd                       ; and save it
         dec      r8                ; prior byte in second number
         ldn      r8                ; get lsb from second number
         adc                        ; add to first number
...
sub32:   inc      r7                ; move to lsb
         ...
         sex      r7                ; point x to first number
         ldn      r8                ; get lsb from second number
         sd                         ; add to first number
         stxd                       ; and save it
         dec      r8                ; prior byte in second number
         ldn      r8                ; get lsb from second number
         sdb                        ; add to first number
         stxd                       ; and save it
         dec      r8                ; prior byte in second number
         ldn      r8                ; get lsb from second number
         sdb                        ; add to first number
...
cmp32:   inc      r7                ; move to lsb
         ...
         ldn      r7                ; get lsb from first number
         sm                         ; subtract
         plo      re                ; save as zero test
         dec      r7                ; point to second byte
         dec      r8
         ldn      r8                ; get 2nd byte of second number
         str      r2                ; store for subtract
         ...
         or                         ; or last result
         plo      re                ; and put back
         dec      r7                ; point to 3rd byte
         dec      r8
         ldn      r8                ; get 3rd byte of second number
         str      r2                ; store for subtract
         ldn      r7                ; get 3rd byte of first number
         smb                        ; perform subtraction
         str      r2                ; store for combining with zero test
         glo      re                ; get zero test
         or                         ; or last result
...
; ***** Numbers in memory stored MSB first   *****
; ************************************************
shl32:   inc      rf                ; move to lsb
         inc      rf
         inc      rf
         sex      rf                ; point x to RF
         ldn      rf                ; get lsb
         shl                        ; shift it
         stxd                       ; store and decrement
         ldn      rf                ; get second byte
         shlc                       ; shift it
         stxd                       ; store and decrement
         ldn      rf                ; get third byte
...
shr32:   ldn      rf                ; get msb
         ...
         shrc                       ; shift it
         str      rf                ; store it
         dec      rf                ; and increment
         dec      rf                ; rf back to msb
         dec      rf
         sep      sret              ; and return
...
norm32:  ldi      0                 ; signal signs are the same
         ...
         dw       comp2s
nrm32n1: ldn      r8                ; get msb of second number
         shl                        ; is it negative
...
scmul4:  inc      r8                ; point to lsb of second number
         inc      r8
         inc      r8
...
scdiv4:  mov      rf,r7             ; point to a
         ...
         dw       sub32
scdiv6:  inc      r8                ; point to lsb of b
         inc      r8
         inc      r8
         ldn      r8                ; get lsb of b
         dec      r8                ; move pointer back
...
atoi:      ldi     0            ; signal positive number
           ...
           str     r2           ; save flag
atoip:     dec     r2           ; protect sign flag
